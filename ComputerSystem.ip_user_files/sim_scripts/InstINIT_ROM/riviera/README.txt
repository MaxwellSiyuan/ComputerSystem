...
#
# Generated by export_simulation on Wed Oct 18 19:11:26 +0800 2017
#
################################################################################
...
switch to the './InstINIT_ROM.sh' script.

./InstINIT_ROM.sh -reset_run
...
./InstINIT_ROM.sh -noclean_files

For more information on the script, please type './InstINIT_ROM.sh -help'.
