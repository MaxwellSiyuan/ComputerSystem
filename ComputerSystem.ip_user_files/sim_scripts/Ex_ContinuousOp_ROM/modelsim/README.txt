...
#
# Generated by export_simulation on Sun Oct 15 12:37:55 +0800 2017
#
################################################################################
...
switch to the './Ex_ContinuousOp_ROM.sh' script.

./Ex_ContinuousOp_ROM.sh -reset_run
...
./Ex_ContinuousOp_ROM.sh -noclean_files

For more information on the script, please type './Ex_ContinuousOp_ROM.sh -help'.
