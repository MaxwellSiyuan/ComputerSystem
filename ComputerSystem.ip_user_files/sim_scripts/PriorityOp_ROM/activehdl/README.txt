...
#
# Generated by export_simulation on Thu Oct 19 14:47:44 +0800 2017
#
################################################################################
...
switch to the './PriorityOp_ROM.sh' script.

./PriorityOp_ROM.sh -reset_run
...
./PriorityOp_ROM.sh -noclean_files

For more information on the script, please type './PriorityOp_ROM.sh -help'.
