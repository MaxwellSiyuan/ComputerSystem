...
HD_PWD='F:/VivadoProject/ComputerSystem/ComputerSystem.runs/InstINIT_ROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InstINIT_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source InstINIT_ROM.tcl
