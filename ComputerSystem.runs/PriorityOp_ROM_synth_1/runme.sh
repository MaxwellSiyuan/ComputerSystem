...
HD_PWD='F:/VivadoProject/ComputerSystem/ComputerSystem.runs/PriorityOp_ROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PriorityOp_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PriorityOp_ROM.tcl
