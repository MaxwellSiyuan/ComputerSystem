...
begin
  ...
  qspo(1) <= \<const0>\;
  qspo(0) <= \<const0>\;
  spo(15 downto 4) <= \^spo\(15 downto 4);
  spo(3) <= \<const0>\;
...
\synth_options.dist_mem_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dist_mem_gen_v8_0_11_synth
     port map (
      a(7 downto 0) => a(7 downto 0),
      clk => clk,
      spo(13 downto 2) => \^spo\(15 downto 4),
