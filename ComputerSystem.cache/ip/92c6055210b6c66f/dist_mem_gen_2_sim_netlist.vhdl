...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rom is
  ...
  attribute SOFT_HLUTNM of \qspo_int[13]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \qspo_int[14]_i_1\ : label is "soft_lutpair1";
...
begin
\qspo_int[12]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => \qspo_int[15]_i_1_n_0\,
      I1 => a(0),
      O => \qspo_int[12]_i_1_n_0\
    );
\qspo_int[13]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\qspo_int[14]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
begin
  ...
  qdpo(1) <= \<const0>\;
  qdpo(0) <= \<const0>\;
  qspo(15 downto 13) <= \^qspo\(15 downto 13);
  qspo(12) <= \^qspo\(0);
  qspo(11) <= \<const0>\;
  qspo(10) <= \<const0>\;
  qspo(9) <= \<const0>\;
...
\synth_options.dist_mem_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dist_mem_gen_v8_0_11_synth
     port map (
      a(7 downto 0) => a(7 downto 0),
      clk => clk,
      qspo(5 downto 3) => \^qspo\(15 downto 13),
      qspo(2) => \^qspo\(0),
      qspo(1 downto 0) => \^qspo\(2 downto 1)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
