...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(a, d, clk, we, i_ce, qspo_ce, qspo_rst, qspo)
/* synthesis syn_black_box black_box_pad_pin="a[7:0],d[7:0],clk,we,i_ce,qspo_ce,qspo_rst,qspo[7:0]" */;
  input [7:0]a;
  input [7:0]d;
  input clk;
  input we;
